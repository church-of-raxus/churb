...
TOKEN = 'O1DIyMTIwOTMyOTQ0MTE3Nzcw.YFNpyA.5KnBYqdnD750VbXHx5SoTSyDQj10'
...
answers = ["I don't know", "Sure", "Ask Raxus", "Not really", "OK", "Definitely.", "<:colinsweat:777620169945120799>:"]
#-----------------------------------------------------------------------#
...
async def on_message(message):
    ...
    elif message.author.id == 256140304401301504:
